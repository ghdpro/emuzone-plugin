...
function emuzone_section_loop( array $emulators ) {
	foreach ($emulators as $emulator)
	{
		...
		emuzone_section_item( $url, $name, $recommended, $platform, $license, $vote_id, $description );
	}
}

function emuzone_section_item( string $url, string $name, bool $recommended = false, string $platform = '', string $license= '', string $vote_id = '', string $description = '' ) {
	?>
	<tr class="emulator">
		...
		<td class="d-none d-md-table-cell align-items-center"><?php emuzone_voting_display( emuzone_voting_rating( $vote_id ) ); ?></td>
	</tr>
