	...
	<table class="form-table">
		<tbody>
			<tr>
				...
				<td><input name="version" id="version" type="text" class="regular-text" value="<?php echo esc_attr( $item->version ?? '' ); ?>"></td>
			</tr>
			<tr>
	...
	<table class="form-table" id="optional"  <?php if ( ! empty( $item->name) ) echo ' style="display:none"'; ?>>
		<tbody>
			<tr>
				...
				<td><input name="name" id="name" type="text" class="regular-text" required value="<?php echo esc_attr( $item->name ?? '' ); ?>"></td>
			</tr>
			<tr>
				<th scope="row"><label for="description">Description</label></th>
				<td><input name="description" id="description" type="text" class="large-text" value="<?php echo esc_attr( $item->description ?? '' ); ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input name="homepage1_url" id="homepage1_url" type="text" class="large-text" value="<?php echo esc_attr( $item->homepage1_url ?? '' ); ?>"></td>
			</tr>
			<tr>
				<th scope="row"><label for="source1_url">Source URL</label> <span class="dashicons dashicons-admin-site-alt3"></span></th>
				<td><input name="source1_url" id="source1_url" type="text" class="large-text" value="<?php echo esc_attr( $item->source1_url ?? '' ); ?>">
